        ...
        <div class="w3-row-padding" style="margin-top:64px">
            <div class="w3-half w3-section">
                <ul class="w3-ul w3-card w3-hover-shadow">
                    ...
                    <li class="w3-padding-16"><b>10</b> Produtos</li>
                    <li class="w3-padding-16"><b>Sem </b> Anúncios</li>
                    <li class="w3-padding-16"><b>Suporte em </b> Horario Comercial</li>
                    <li class="w3-padding-16">
                        <h2 class="w3-opacity">R$ 25</h2>
                    </li>
            ...
            <div class="w3-half w3-section">
                <ul class="w3-ul w3-card w3-hover-shadow">
                    ...
                    <li class="w3-padding-16"><b>50</b> Produtos</li>
                    <li class="w3-padding-16"><b>Sem </b> Anúncios</li>
                    <li class="w3-padding-16"><b>Suporte</b> Imediato</li>
                    <li class="w3-padding-16">
                        <h2 class="w3-opacity">R$ 50</h2>
                    </li>
                    <li class="w3-light-grey w3-padding-24">
                        <button class="w3-button w3-black w3-padding-large"
                            onclick="document.getElementById('download').style.display='block'"> <i
